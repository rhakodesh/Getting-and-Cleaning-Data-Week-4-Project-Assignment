...
## Files:
CodeBook.md describes the how to use all these; variables, the data, and any transformations or work that was performed to clean up the data.
...
The output of the final step tidydata.txt 
